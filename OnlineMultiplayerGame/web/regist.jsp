...
<form action="registServlet" method="post">
    <br>
            <table>
                <tr>
                    <td></td><td><INPUT style="WIDTH: 120px" value="" name=account></td>
                    </tr>
                
					<tr>
                    <td></td><td><INPUT style="WIDTH: 120px" value="" name=name></td>
                    </tr>
		
						<tr>
                    <td></td><td><INPUT type=password style="WIDTH: 120px" value="" name=password></td>
                       </tr>

						<tr>
					<td></td><td><INPUT type=password style="WIDTH: 120px" value="" name=repassword></td>
                    </tr>
					<tr>
	...
	<div class="sideitem">
			 <div class="boxhead"><div class="headfill">&nbsp;</div></div>
				...
				<div class="boxbody">
					...
					<h2></h2>
					<ul>
					<li class="page_item"><a href="#" title="1">1.1-3(120123)</a></li>
					<li class="page_item"><a href="#" title="2">2.2-3(114679)</a></li>
